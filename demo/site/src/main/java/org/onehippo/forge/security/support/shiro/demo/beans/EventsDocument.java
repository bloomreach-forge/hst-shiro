...
@HippoEssentialsGenerated(internalName = "hstshirointegdemo:eventsdocument")
@Node(jcrType="hstshirointegdemo:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public final static String DOCUMENT_TYPE = "hstshirointegdemo:eventsdocument";
    ...
    private final static String END_DATE = "hstshirointegdemo:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "hstshirointegdemo:enddate")
